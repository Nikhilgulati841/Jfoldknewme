...
#  password generator using a number of words and then shuffle the letters of the word as well as each word in the list and join them.
#  Password generator using imprt string (give the user the option to choose the length and what all things needs to be included)
import random
import string
